...
public class AgendaService {
    ...
    public ResponseEntity<String> createAgenda(AgendaDTO agenda, Long cursoId, Long professorId) throws ParseException {
        ...
        entity.setStart_date(format.parse(agenda.getStart_date()));
        entity.setEnd_date(format.parse(agenda.getEnd_date()));
        ...
        if (!professorIsInCurso(curso, professor)) {
            return ResponseEntity.status(400).body("Professor deve conter o Curso em sua grade");
        }
